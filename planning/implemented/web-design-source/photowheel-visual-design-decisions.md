...
documents. Where earlier documents (e.g. `webui-component-mapping-phase1.md` §7.1)
...
| `design/web/webui-component-mapping-phase1.md` §2.2, §7.1 | Mockup analysis and interaction spec |
| `design/web/webui-design-tokens-phase1.md` | Token catalogue |
...
rules from `webui-component-mapping-phase1.md` §6 apply (reduced visible
card count).
