...
from nightfall_photo_ingress.onedrive.cache_lock import SingletonLockBusyError
from nightfall_photo_ingress.onedrive.client import GraphError, poll_accounts
...
def test_v2_chunk8_singleton_guard_blocks_concurrent_poll(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("nightfall_photo_ingress.onedrive.client.account_singleton_lock", _busy_lock)
