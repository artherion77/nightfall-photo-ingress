...
**Full specification:** [observability.md](observability.md) — complete JSON log field schema, human vs. JSON mode comparison, safe_logging design, and status snapshot writer contract  
**See also:** [error-model.md](error-model.md), [lifecycle.md](lifecycle.md)
