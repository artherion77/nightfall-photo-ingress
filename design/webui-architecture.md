...
SSR remains a viable future upgrade path. See `design/phase2-architecture.md` §7 for the conditions under which SSR adoption is warranted and the migration steps to `@sveltejs/adapter-node`.
