...
| `audit/security-thread-model-md` | `/audit/threat-model.md` | **Maps cleanly but: (a) empty, (b) incorrect filename — missing `.md` extension** |
| `audit/open ponts/` directory | No proposed target | **No mapping — directory name contains a typo ("ponts" not "points"); content has no home in proposed structure; recommend adding `/audit/open-points/`** |
...
|---|---|---|
| `audit/security-thread-model-md` has no `.md` extension | `audit/` | Rename to `security-threat-model.md` |
| `audit/open ponts/` contains a typo in the directory name | `audit/` | Rename to `audit/open-points/` |
| `audit/drift-analysis.md`, `audit/review-history.md`, `audit/security-thread-model-md` are all empty stubs | `audit/` | Author or delete |
...
1. Rename `audit/security-thread-model-md` → `audit/security-threat-model.md`
2. Rename `audit/open ponts/` → `audit/open-points/`
